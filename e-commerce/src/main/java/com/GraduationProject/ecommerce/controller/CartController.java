...
import com.GraduationProject.ecommerce.service.CartService;
...
public class CartController {
    ...
    /**
     * Adds a product to the logged-in user's shopping cart.
     */
    ...
    /**
     * Returns all products in the logged-in user's shopping cart.
     */
    @PreAuthorize("hasRole('User')")
